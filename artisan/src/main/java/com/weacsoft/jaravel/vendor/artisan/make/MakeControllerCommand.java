...
public class MakeControllerCommand extends ArtisanCommand {
    ...
    public String description() {
        return "生成 Controller 类（对齐 Laravel php artisan make:controller）";
    }
    ...
    public int handle() {
        ...
        try {
            String path = MakeGenerator.generateController(properties, name, force);
            info("Controller created: " + path);
            return 0;
