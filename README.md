...
| migration | `migration` | Blueprint/Schema/Migrator（运行时编译，3种源模式，MySQL/SQLite/H2/SQL Server/PostgreSQL/Oracle，跨库表迁移） | [README](migration/README.md) | [AI-API](migration/AI-API.md) |
...
| captcha | `captcha` | 图形验证码（CaptchaBuilder/字体干扰/Base64输出） | [README](captcha/README.md) | [AI-API](captcha/AI-API.md) |
