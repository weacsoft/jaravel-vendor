...
import com.weacsoft.jaravel.vendor.migration.MigrationCLI;
 ...
 * <p>
 * <b>设计说明</b>：迁移核心逻辑（{@code MigrationExecutor}、{@code Migrator}、
 * {@code Schema}、{@code MigrationRepository}、{@code MigrationScanner}）已完全独立于 SpringBoot，
 ...
 * <p>
 * Spring 装配收口于 springboot 模块（migration 核心模块零 Spring 依赖）。
 */
@AutoConfiguration
...
public class MigrationAutoConfiguration {
     ...
     * <p>
     * {@link MigrationProperties} 本身为纯 POJO（无 Spring 注解，留在 migration 模块），
