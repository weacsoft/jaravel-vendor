 ...
 * 实例化 {@link MigrationExecutor} 调用 {@code MigrationExecutor#execute(String...)}。
 * <p>
 * 通过启动参数触发：
 * <ul>
 ...
 * <p>
 * 实现 {@code CommandLineRunner}（spring-boot），故随装配同位于 springboot 模块（migration 核心模块零 Spring 依赖）。
 */
